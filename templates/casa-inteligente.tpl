...
<div class="container">		
	<div class="row-fluid">
    	<div class="span9">
            <!-- Our Services -->
            <div class="row-fluid">
                <div class="headline"><h3>Casa Inteligente</h3></div>
                <div class="row-fluid margin-bottom-40">
                    <div class="span12">
                        <h4><a href="#"></a></h4>
			<p></p>
			<h4>Manejo de Aparatos y Dispositivos</h4>
			<h4>Seguridad del Hogar</h4>
			<h4>Jardin Inteligente</h4>
			<h4>Control de Temperatura Ambiental</h4>
			<h4>Iluminacion Inteligente</h4>
                    </div>
                </div><!--/welcome-block-->
            </div><!--/row-fluid-->        
